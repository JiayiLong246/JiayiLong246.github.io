...
## Projects
------
+ **识界 LumiX：融合理解型读屏 GUI Agent 可控自动化操作的多模态智能体系统设计**
<br>**项目简介**：项目面向手机智能交互场景，结合多模态人工智能、屏幕图像识别、语音交互和任务规划等技术，实现对手机界面的理解与自动操作。系统可以根据用户指令完成信息查询、界面点击和连续任务执行，提高人机交互的智能化和便捷性。
+ **融合 Transformer 和 LSTM 的业务流程下一事件预测**<br>
  **项目简介**：针对业务流程中下一事件预测的问题，构建融合 Transformer 和 LSTM 的预测模型。项目通过对业务流程数据进行编码和分析，利用 LSTM 提取流程中的时序特征，利用 Transformer 捕捉事件之间的长期依赖关系，从而预测业务流程中可能发生的下一个事件。

  
## Awards
------
+ **隆嘉仪(排名1/3)**. 全国大学生计算机设计大赛**国家一等奖** 2026.08
+ **隆嘉仪(排名1/3)**. 中国大学生计算机设计大赛中南地区赛**省级一等奖** 2026.07
+ **隆嘉仪(排名1/3）**. 中国高校计算机大赛2026网络技术挑战赛华中赛区**省级一等奖** 2026.06
+ **隆嘉仪**. 蓝桥杯软件和信息技术专业人才大赛C/C++程序设计组**省级二等奖** 2026.05
